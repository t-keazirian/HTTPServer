...
public class RouterTests
{
    ...
    {
        List<Route> testRoute = new List<Route>
        {
            new Route("/test_path", new List<HttpMethod> { HttpMethod.GET }, new MockHandler()),
        };
        RoutesConfig routesConfig = new RoutesConfig(testRoute);
        Request testRequest =
            new Request(HttpMethod.GET, "/test_path", "", "");

        Router router = new Router(routesConfig);
